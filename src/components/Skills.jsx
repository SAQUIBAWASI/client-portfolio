...
const Skills = () => {
  ...
  const skills = [
    { 
      ...
      items: ["Object Detection", "Image Classification", "Semantic Segmentation", "Face Recognition", "Pose Estimation", "OCR", "3D Vision"],
      icon: (
    ...
    { 
      ...
      items: ["TensorFlow", "PyTorch", "Keras", "CNN", "RNN", "Transformers", "GAN", "Transfer Learning"],
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    { 
      ...
      items: ["Python", "C++", "Java", "CUDA", "OpenCV", "Scikit-Learn", "NumPy", "Pandas"],
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    { 
      category: "Deployment",
      items: ["Docker", "Kubernetes", "AWS", "Azure", "GCP", "NVIDIA Jetson", "TensorRT", "ONNX"],
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div>
                <div className="flex justify-between mb-2">
                  <span className="text-white font-medium">Computer Vision Algorithms</span>
            ...
            <div className="space-y-6">
              ...
              <div>
                <div className="flex justify-between mb-2">
                  <span className="text-white font-medium">Edge AI Deployment</span>
